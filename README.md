...
```
DATABASE_URL=postgresql://<YOUR_DB_USERNAME>@localhost:5432/vercel-blitz-reproduction
```

Ensure the `.env.test.local` file has required environment variables:

```
DATABASE_URL=postgresql://<YOUR_DB_USERNAME>@localhost:5432/vercel-blitz-reproduction_test
```
